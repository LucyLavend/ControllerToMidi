...
public class Testing : Control
{
    ...
    public void playNote(int midiNote, int velocity)
    {
        using (var outputDevice = OutputDevice.GetByName(port))
        {
            ...
            outputDevice.SendEvent(new NoteOnEvent((SevenBitNumber)midiNote, (SevenBitNumber)velocity));
        }
    }
    ...
    public void stopNote(int midiNote, int velocity = 0)
    {
        using (var outputDevice = OutputDevice.GetByName(port))
        {
            ...
            outputDevice.SendEvent(new NoteOffEvent((SevenBitNumber)midiNote, (SevenBitNumber)velocity));
        }
    }
